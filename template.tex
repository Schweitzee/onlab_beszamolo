...
%\feladatcim argumentuma a feladat rövid, 1 soros címe
  \feladatcim{Többutas médiaátvitel QUIC felett (Multipath MoQ)} 

  %\feladatmaga argumentuma a feladat 1-2 bekezdésnyi ismertetése
  \feladatmaga{A Multipath tulajdonságokat megvalósító PicoQuic könyvtárra 
  építő LibQuicR projekt módosítása úgy, hogy az képes legyen multipath 
  alkalmazására. Valamint ennek a demonstrálása azzal, hogy egy virtuális környezetben
  többutas adatátvitelt valósítunk meg a LibQuicR segítségével, ahol bármely 
  multipath kapcsolat valamely útvonalát megszakítjuk, akkor minimális fennakadással
  és beavatkozás nélkül tudja az adatátvitelt fenntartani a LibQuicR alkalmazás.}
