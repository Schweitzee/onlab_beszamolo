...
%\feladatcim argumentuma a feladat rövid, 1 soros címe
  ...
  multipath adatátviteli képességeket, amelyeket a PicoQUIC nevű, 
...
A hálózati topológia e szerepkörök között lehet lineáris 
(Publisher → Relay → Subscriber), vagy elágazó, illetve mesh alapú, ahol több 
relay dolgozik együtt. Ez a struktúra lehetőséget biztosít a tartalom dinamikus 
...
rendelkeznek (például Wi-Fi + mobil adatkapcsolat). A relay-ek és végpontok 
